      ...
      { 
        ...
        // 本行要输出内容 show_content 为转换为A指令后的
         ...
         {  
            ...
            read_line( show_content,(z-1), this );
         }
         else
         {   
           read_line(  E_To_A(memory[z]) , z , this);
         }
      }
...
function read_line(arr,num,current_tec)  // arr由 1到3项组成
{  

   //将p添加到console_div 
   var console_div = document.getElementById('console'+current_tec.num);
